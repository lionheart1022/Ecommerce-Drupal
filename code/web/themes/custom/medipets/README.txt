...
http://foundation.zurb.com/docs/faq.php or use the script in the medipets
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the medipets folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/medipets folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the medipets.info.yml.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/medipets.info.yml.txt file to foo/foo.info.yml. Edit the
    foo.info.yml file and change "name: Foundation Sub-theme medipets" to
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename medipets.libraries.yml to the name of your sub-theme, un-commenting
