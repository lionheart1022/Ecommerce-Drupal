...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the dcom_56cbd folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/dcom_56cbd folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the dcom_56cbd.info.yml.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/dcom_56cbd.info.yml.txt file to foo/foo.info.yml. Edit the
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    First, rename dcom_56cbd.theme to include the name of your new sub-theme. In this
    example we'll assume that it's renamed foo.theme.

    Edit the foo.theme and theme-settings.php files in your sub-theme's
    folder; replace ALL occurrences of "dcom_56cbd" with the name of your
    sub-theme.

    For example, edit foo/foo.theme and foo/theme-settings.php and replace
    every occurrence of "dcom_56cbd" with "foo".
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename dcom_56cbd.libraries.yml to the name of your sub-theme, un-commenting
