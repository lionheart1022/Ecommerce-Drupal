...
http://foundation.zurb.com/docs/faq.php or use the script in the diamondcbd
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the diamondcbd folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/diamondcbd folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the diamondcbd.info.yml.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/diamondcbd.info.yml.txt file to foo/foo.info.yml. Edit the
    foo.info.yml file and change "name: Foundation Sub-theme diamondcbd" to
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    First, rename diamondcbd.theme to include the name of your new sub-theme. In this
    example we'll assume that it's renamed foo.theme.

    Edit the foo.theme and theme-settings.php files in your sub-theme's
    folder; replace ALL occurrences of "diamondcbd" with the name of your
    sub-theme.

    For example, edit foo/foo.theme and foo/theme-settings.php and replace
    every occurrence of "diamondcbd" with "foo".
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename diamondcbd.libraries.yml to the name of your sub-theme, un-commenting
